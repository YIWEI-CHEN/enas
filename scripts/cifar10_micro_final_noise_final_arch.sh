...
fixed_arc="1 1 0 4 1 1 0 1 3 0 1 4 0 1 1 1 1 0 1 1"
fixed_arc="$fixed_arc 0 1 0 3 0 1 0 0 0 0 0 2 0 4 1 0 1 4 0 1"
...
python src/cifar10/main.py \
  ...
  --output_dir="0423/micro_final_uniform_noise_08_final_arch" \
  --batch_size=144 \
  --num_epochs=630 \
  --log_every=50 \
  --eval_every_epochs=1 \
