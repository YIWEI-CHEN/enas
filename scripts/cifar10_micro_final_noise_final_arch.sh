...
fixed_arc="0 1 1 1 1 3 0 0 1 4 1 1 1 3 0 1 0 1 0 1"
fixed_arc="$fixed_arc 0 2 1 1 1 4 1 4 2 2 2 1 2 3 2 4 1 3 1 2"
...
python src/cifar10/main.py \
  ...
  --output_dir="0419/micro_final_noise_final_arch" \
  --batch_size=144 \
  --num_epochs=630 \
  --log_every=50 \
  --eval_every_epochs=1 \
