...
fixed_arc="1 3 0 0 0 1 1 1 2 0 0 1 0 1 4 3 4 1 4 0"
fixed_arc="$fixed_arc 1 2 0 3 2 1 0 0 3 0 0 0 3 4 0 0 1 4 1 2"
DATE=`date +%m%d`
...
python src/cifar10/main.py \
  ...
  --output_dir="${DATE}/${RANK}/micro_final_${NOISE}_${LOSS_FUNC}_gpu${GPU}_epoch1" \
  --batch_size=144 \
  --num_epochs=300 \
  --log_every=50 \
  --eval_every_epochs=1 \
