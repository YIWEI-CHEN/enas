...
fixed_arc="0 0 0 0 0 0 2 0 3 1 3 4 4 4 3 0 2 1 5 1"
fixed_arc="$fixed_arc 0 4 1 0 1 0 2 0 3 0 1 3 3 4 1 0 0 1 1 4"
...
python src/cifar10/main.py \
  ...
  --output_dir="0419/micro_final_noise_init_arch" \
  --batch_size=144 \
  --num_epochs=630 \
  --log_every=50 \
  --eval_every_epochs=1 \
