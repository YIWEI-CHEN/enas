...
SEED=2019  # change
GPU=0  # change
fixed_arc=${CLEAN_TRAIN_2019}  # change
arc_name="CLEAN_TRAIN_${SEED}"
...
OUTPUT="/home/yiwei/enas/logs/micro_clean_final/${DATASET}_seed${SEED}_${LOSS_FUNC}_${arc_name}_gpu${GPU}-${DATE}"
